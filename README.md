...
The `headertoken` string could be any HTTP accepted header. However, we are using the following:
    ...
    - __toolbarheight__: This will change the height of toolbar. NOTE: This normally does not need to be set. If the 'hideallbuttons' is set, this will change automatically. Changing it manually can cause unwanted behaviour.
    - __toolbarFooterHeight__: This will change the overall height of the footer. NOTE: This normally does not need to be set. If the 'hideallbuttons' is set, this will change automatically. Changing it manually can cause unwanted behaviour.
